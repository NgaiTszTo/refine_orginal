...
refine$product_smartphone <- if_else(refine$'product category' == "Smartphone", 1,0)
refine$product_tv <- if_else(refine$'product category' == "TV", 1,0)
refine$product_laptop <- if_else(refine$'product category' == "Laptop", 1,0)
refine$product_tablet <- if_else(refine$'product category' == "Tablet", 1,0)
